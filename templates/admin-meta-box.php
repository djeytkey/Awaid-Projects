...
<div class="awaid-admin-meta">
	<div class="awaid-admin-section">
		<table class="form-table awaid-form-table">
			<tr>
				...
				<td><input type="text" class="widefat" id="awaid_location" name="awaid_project[location]"
						value="<?php echo esc_attr((string) $d['location']); ?>"
						placeholder="<?php esc_attr_e('مثال الرياض - القيروان', 'awaid-projects'); ?>"></td>
			</tr>
			<tr>
				<th><label for="awaid_developer"><?php esc_html_e('المطور', 'awaid-projects'); ?></label></th>
				<td><input type="text" class="widefat" id="awaid_developer" name="awaid_project[developer]"
						value="<?php echo esc_attr((string) $d['developer']); ?>"></td>
			</tr>
		</table>
	</div>
	...
	<div class="awaid-admin-section">
		...
		<!-- <p class="description"><?php esc_html_e('أضف صورًا متعددة لعرض الصور في شريط الصور الخاص بالمشروع الواحد. تظهر الصور بالترتيب الذي أضفتها به؛ يمكنك حذف الصور وإعادة إضافتها لتغيير الترتيب.', 'awaid-projects'); ?></p> -->
		<input type="hidden" id="awaid_gallery_csv" name="awaid_project[gallery_csv]"
			value="<?php echo esc_attr($gallery_csv); ?>">
		<p>
			<button type="button" class="button"
				id="awaid_gallery_add"><?php esc_html_e('أضف صورًا', 'awaid-projects'); ?></button>
		</p>
		<ul class="awaid-gallery-grid" id="awaid_gallery_list">
			<?php foreach ($gallery_ids as $gid): ?>
				...
				<li class="awaid-gallery-item" data-id="<?php echo esc_attr((string) $gid); ?>">
					<span class="awaid-gallery-thumb"><img src="<?php echo esc_url((string) $turl); ?>" alt=""
							loading="lazy" decoding="async"></span>
					<button type="button" class="button button-small awaid-gallery-remove"
						data-id="<?php echo esc_attr((string) $gid); ?>"><?php esc_html_e('حذف', 'awaid-projects'); ?></button>
				</li>
			<?php endforeach; ?>
		</ul>
	</div>
	...
	<div class="awaid-admin-section">
		...
		<table class="form-table awaid-form-table">
			<tr>
				...
				<td><input type="text" class="widefat" id="awaid_license" name="awaid_project[license]"
						value="<?php echo esc_attr((string) $d['license']); ?>"></td>
			</tr>
			<tr>
				<th><label for="awaid_listing_date"><?php esc_html_e('تاريخ النشر', 'awaid-projects'); ?></label></th>
				<td><input type="text" class="widefat" id="awaid_listing_date" name="awaid_project[listing_date]"
						value="<?php echo esc_attr((string) $d['listing_date']); ?>"
						placeholder="<?php esc_attr_e('مثال 2025-04-16', 'awaid-projects'); ?>"></td>
			</tr>
			<tr>
				<th><?php esc_html_e('السعر', 'awaid-projects'); ?></th>
				<td class="awaid-inline-fields">
					<label><span class="screen-reader-text"><?php esc_html_e('الأدنى', 'awaid-projects'); ?></span>
						<input type="text" name="awaid_project[price_min]"
							value="<?php echo esc_attr((string) $d['price_min']); ?>"
							placeholder="<?php esc_attr_e('من', 'awaid-projects'); ?>">
					</label>
					<span class="awaid-sep">—</span>
					<label><span class="screen-reader-text"><?php esc_html_e('الأقصى', 'awaid-projects'); ?></span>
						<input type="text" name="awaid_project[price_max]"
							value="<?php echo esc_attr((string) $d['price_max']); ?>"
							placeholder="<?php esc_attr_e('إلى', 'awaid-projects'); ?>">
					</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="hidden" id="awaid_brochure_id" name="awaid_project[brochure_id]"
						value="<?php echo esc_attr((string) $brochure_id); ?>">
					<button type="button" class="button"
						id="awaid_brochure_pick"><?php esc_html_e('حدد الملف', 'awaid-projects'); ?></button>
					<button type="button" class="button"
						id="awaid_brochure_clear"><?php esc_html_e('مسح الملف', 'awaid-projects'); ?></button>
					<p class="description awaid-brochure-file" id="awaid_brochure_label">
						<?php echo $brochure_url ? esc_html(basename($brochure_url)) : esc_html__('لم يتم تحديد أي ملف.', 'awaid-projects'); ?>
					</p>
				</td>
			</tr>
		</table>
	...
	<div class="awaid-admin-section">
		...
		<table class="form-table awaid-form-table">
			<tr>
				...
				<td class="awaid-inline-fields">
					<input type="text" name="awaid_project[area_min]"
						value="<?php echo esc_attr((string) $d['area_min']); ?>"
						placeholder="<?php esc_attr_e('Min', 'awaid-projects'); ?>">
					<span class="awaid-sep">—</span>
					<input type="text" name="awaid_project[area_max]"
						value="<?php echo esc_attr((string) $d['area_max']); ?>"
						placeholder="<?php esc_attr_e('Max', 'awaid-projects'); ?>">
				</td>
			</tr>
			<tr>
				<th><label for="awaid_bedrooms"><?php esc_html_e('غرف النوم', 'awaid-projects'); ?></label></th>
				<td><input type="text" id="awaid_bedrooms" name="awaid_project[bedrooms]"
						value="<?php echo esc_attr((string) $d['bedrooms']); ?>"></td>
			</tr>
			<tr>
				<th><label for="awaid_bathrooms"><?php esc_html_e('الحمامات', 'awaid-projects'); ?></label></th>
				<td><input type="text" id="awaid_bathrooms" name="awaid_project[bathrooms]"
						value="<?php echo esc_attr((string) $d['bathrooms']); ?>"></td>
			</tr>
			<tr>
				<th><label for="awaid_floors"><?php esc_html_e('المطابخ', 'awaid-projects'); ?></label></th>
				<td><input type="text" id="awaid_floors" name="awaid_project[floors]"
						value="<?php echo esc_attr((string) $d['floors']); ?>"></td>
			</tr>
		</table>
	</div>
	...
	<div class="awaid-admin-section">
		...
		<table class="form-table awaid-form-table">
			<tr>
				...
				<td><input type="url" class="widefat" id="awaid_map_url" name="awaid_project[map_url]"
						value="<?php echo esc_attr((string) $d['map_url']); ?>"></td>
			</tr>
		</table>
	</div>
			...
			<div class="awaid-catalog-options" id="awaid-feature-options">
				<?php foreach ($catalog_features as $feature): ?>
					...
					<label class="awaid-catalog-option">
						<input type="checkbox" name="awaid_project[feature_ids][]" value="<?php echo esc_attr($feature_id); ?>"
							<?php checked(in_array($feature_id, $selected_feature_ids, true)); ?>>
		...
		<?php if ($catalog_warranties): ?>
			...
			<div class="awaid-catalog-options" id="awaid-warranty-options">
				<?php foreach ($catalog_warranties as $warranty): ?>
					...
					?>
					<label class="awaid-catalog-option">
						<input type="checkbox" name="awaid_project[warranty_ids][]"
							value="<?php echo esc_attr($warranty_id); ?>" <?php checked(in_array($warranty_id, $selected_warranty_ids, true)); ?>>
						<span class="awaid-catalog-option__body">
							<?php if ($warranty_icon !== ''): ?>
								<i data-lucide="<?php echo esc_attr($warranty_icon); ?>" class="awaid-lucide-icon"
									aria-hidden="true"></i>
							<?php endif; ?>
		...
		<?php if ($catalog_nearby): ?>
			...
			<div class="awaid-catalog-options" id="awaid-nearby-options">
				<?php foreach ($catalog_nearby as $nearby): ?>
					...
					?>
					<label class="awaid-catalog-option">
						<input type="checkbox" name="awaid_project[nearby_ids][]" value="<?php echo esc_attr($nearby_id); ?>"
							<?php checked(in_array($nearby_id, $selected_nearby_ids, true)); ?>>
						<span class="awaid-catalog-option__body">
							<?php if ($nearby_icon !== ''): ?>
								<i data-lucide="<?php echo esc_attr($nearby_icon); ?>" class="awaid-lucide-icon"
									aria-hidden="true"></i>
							<?php endif; ?>
	...
	<div class="awaid-admin-section">
		<h3><?php esc_html_e('الوحدات', 'awaid-projects'); ?></h3>
		<table class="widefat awaid-units-table" id="awaid_units_table">
			<!-- <thead>
				<tr>
					<th><?php esc_html_e('اسم الوحدة', 'awaid-projects'); ?></th>
					<th><?php esc_html_e('نوع الوحدة', 'awaid-projects'); ?></th>
					<th><?php esc_html_e('السعر', 'awaid-projects'); ?></th>
					<th><?php esc_html_e('المساحة م²', 'awaid-projects'); ?></th>
					<th><?php esc_html_e('غرف النوم', 'awaid-projects'); ?></th>
					<th><?php esc_html_e('الحمامات', 'awaid-projects'); ?></th>
					<th><?php esc_html_e('الحالة', 'awaid-projects'); ?></th>
			...
			<?php foreach ($units as $i => $row): ?>
				...
				<tbody class="awaid-unit-block">
					...
					<tr class="awaid-repeater-row awaid-unit-block__main">
						<td><input type="text" name="awaid_project[units][<?php echo esc_attr($uid); ?>][code]"
								value="<?php echo esc_attr((string) ($row['code'] ?? '')); ?>"></td>
						<td><input type="text" name="awaid_project[units][<?php echo esc_attr($uid); ?>][type]"
								value="<?php echo esc_attr((string) ($row['type'] ?? '')); ?>"></td>
						<td><input type="text" name="awaid_project[units][<?php echo esc_attr($uid); ?>][price]"
								value="<?php echo esc_attr((string) ($row['price'] ?? '')); ?>"></td>
						<td><input type="text" name="awaid_project[units][<?php echo esc_attr($uid); ?>][area]"
								value="<?php echo esc_attr((string) ($row['area'] ?? '')); ?>"></td>
						<td><input type="text" name="awaid_project[units][<?php echo esc_attr($uid); ?>][bedrooms]"
								value="<?php echo esc_attr((string) ($row['bedrooms'] ?? '')); ?>"></td>
						<td><input type="text" name="awaid_project[units][<?php echo esc_attr($uid); ?>][bathrooms]"
								value="<?php echo esc_attr((string) ($row['bathrooms'] ?? '')); ?>"></td>
						<td>
						...
						<td><button type="button"
								class="button awaid-unit-remove"><?php esc_html_e('حذف', 'awaid-projects'); ?></button></td>
					</tr>
					<tr class="awaid-unit-block__detail">
						<td colspan="8" class="awaid-unit-block__detail-cell">
							<p><strong><?php esc_html_e('معرض الوحدات (شريط تمرير منبثق)', 'awaid-projects'); ?></strong>
							</p>
							<input type="hidden" class="awaid-unit-gallery-csv"
								name="awaid_project[units][<?php echo esc_attr($uid); ?>][gallery_csv]"
								value="<?php echo esc_attr($ug_csv); ?>">
							<p>
								<button type="button"
									class="button awaid-unit-gallery-add"><?php esc_html_e('أضف صورًا', 'awaid-projects'); ?></button>
							</p>
							<ul class="awaid-gallery-grid awaid-unit-gallery-list">
								<?php foreach ($ug_ids as $gid): ?>
									...
									?>
									<li class="awaid-gallery-item" data-id="<?php echo esc_attr((string) $gid); ?>">
										<span class="awaid-gallery-thumb"><img src="<?php echo esc_url((string) $turl); ?>"
												alt="" loading="lazy" decoding="async"></span>
										<button type="button" class="button button-small awaid-unit-gallery-remove"
											data-id="<?php echo esc_attr((string) $gid); ?>"><?php esc_html_e('حذف', 'awaid-projects'); ?></button>
									</li>
								<?php endforeach; ?>
							</ul>
							<p><label><strong><?php esc_html_e('الوصف', 'awaid-projects'); ?></strong><br>
									<textarea class="widefat" rows="3"
										name="awaid_project[units][<?php echo esc_attr($uid); ?>][description]"><?php echo esc_textarea((string) ($row['description'] ?? '')); ?></textarea></label>
							</p>
							<table class="form-table awaid-form-table">
								<tr>
									<th><?php esc_html_e('الدور', 'awaid-projects'); ?></th>
									<td><input type="text" class="widefat"
											name="awaid_project[units][<?php echo esc_attr($uid); ?>][floor]"
											value="<?php echo esc_attr((string) ($row['floor'] ?? '')); ?>"></td>
								</tr>
								<tr>
									<th><?php esc_html_e('المطابخ', 'awaid-projects'); ?></th>
									<td><input type="text" class="widefat"
											name="awaid_project[units][<?php echo esc_attr($uid); ?>][kitchens]"
											value="<?php echo esc_attr((string) ($row['kitchens'] ?? '')); ?>"></td>
								</tr>
								<tr>
									<th><?php esc_html_e('رقم واتساب', 'awaid-projects'); ?></th>
									<td><input type="text" class="widefat"
											name="awaid_project[units][<?php echo esc_attr($uid); ?>][whatsapp]"
											value="<?php echo esc_attr((string) ($row['whatsapp'] ?? '')); ?>"
											placeholder="<?php esc_attr_e('e.g. 9665xxxxxxxx', 'awaid-projects'); ?>"></td>
								</tr>
								<tr>
									<th><?php esc_html_e('الهاتف', 'awaid-projects'); ?></th>
									<td><input type="text" class="widefat"
											name="awaid_project[units][<?php echo esc_attr($uid); ?>][phone]"
		...
		<p><button type="button" class="button"
				data-awaid-add-unit><?php esc_html_e('أضف وحدة', 'awaid-projects'); ?></button></p>
	</div>
</div>
...
<script type="text/html" id="tmpl-awaid-unit-block">
	<tbody class="awaid-unit-block">
		<tr class="awaid-unit-block__labels">
			<th><?php echo esc_html(__('اسم الوحدة', 'awaid-projects')); ?></th>
			<th><?php echo esc_html(__('نوع الوحدة', 'awaid-projects')); ?></th>
			<th><?php echo esc_html(__('السعر', 'awaid-projects')); ?></th>
			<th><?php echo esc_html(__('المساحة م²', 'awaid-projects')); ?></th>
			<th><?php echo esc_html(__('غرف النوم', 'awaid-projects')); ?></th>
			<th><?php echo esc_html(__('الحمامات', 'awaid-projects')); ?></th>
			<th><?php echo esc_html(__('الحالة', 'awaid-projects')); ?></th>
			<th class="awaid-col-actions"></th>
		</tr>
		<tr class="awaid-repeater-row awaid-unit-block__main">
			...
			<td><button type="button" class="button awaid-unit-remove"><?php echo esc_html(__('حذف', 'awaid-projects')); ?></button></td>
		</tr>
		<tr class="awaid-unit-block__detail">
			<td colspan="8" class="awaid-unit-block__detail-cell">
				<p><strong><?php echo esc_html(__('معرض الوحدات (شريط تمرير منبثق)', 'awaid-projects')); ?></strong></p>
				<input type="hidden" class="awaid-unit-gallery-csv" name="awaid_project[units][__i__][gallery_csv]" value="">
				<p><button type="button" class="button awaid-unit-gallery-add"><?php echo esc_html(__('أضف صورًا', 'awaid-projects')); ?></button></p>
				<ul class="awaid-gallery-grid awaid-unit-gallery-list"></ul>
				<p><label><strong><?php echo esc_html(__('الوصف', 'awaid-projects')); ?></strong><br>
					<textarea class="widefat" rows="3" name="awaid_project[units][__i__][description]"></textarea></label></p>
				<table class="form-table awaid-form-table">
					<tr><th><?php echo esc_html(__('الدور', 'awaid-projects')); ?></th><td><input type="text" class="widefat" name="awaid_project[units][__i__][floor]" value=""></td></tr>
					<tr><th><?php echo esc_html(__('المطابخ', 'awaid-projects')); ?></th><td><input type="text" class="widefat" name="awaid_project[units][__i__][kitchens]" value=""></td></tr>
