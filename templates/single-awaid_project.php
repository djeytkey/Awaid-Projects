...
?>
		<div class="<?php echo esc_attr($base); ?>">
			...
			<div class="awaid-sidebar-card__actions">
				<?php if ($brochure_url) : ?>
					<a class="awaid-btn awaid-btn--secondary awaid-btn--block" href="<?php echo esc_url($brochure_url); ?>" target="_blank" rel="noopener"><i class="fa fa-eye"></i> <?php esc_html_e('عرض ملف المشروع', 'awaid-projects'); ?></a>
				<?php endif; ?>
			</div>
		</div>
	<?php
